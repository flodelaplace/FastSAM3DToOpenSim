...
def _read_body_meshes(osim_path: str) -> dict[str, list[dict]]:
    ...
    Path (b) is how flodelaplace_mocap.osim carries the 20 torso meshes
    (cerv1-7, thoracic1-12, hat_ribs_scap). Without reading the POF offsets,
    individual vertebrae would collapse to the torso origin, so
    load_geometry_meshes used to skip them. With POF translations correctly
    read, vertebrae can be displayed at their anatomical position.
    """
